...
with app.app_context():
    ...
    guest1 = Guest(name="Eugene Ayuka", occupation="Software Engineer")
    guest2 = Guest(name="Morgan Mash", occupation="Engineer")
    guest3 = Guest(name="Kevin Durant", occupation="Banker")
    guest4 = Guest(name="Bruce Wayne", occupation="Engineer")
    guest5 = Guest(name="Satoshi Nakamoto", occupation="Business Person")
    guest6 = Guest(name="Sahbabii ", occupation="Doctor")
    guest7 = Guest(name="Ghibli Studios", occupation="Teacher")
